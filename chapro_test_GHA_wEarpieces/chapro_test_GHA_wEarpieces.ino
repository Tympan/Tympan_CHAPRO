...
AudioConnection_F32 patchCord1(i2s_in, EarpieceShield::PDM_LEFT_FRONT, BTNRH_alg1, 0);  //left input

//connect the BTNRH alg to the outputs
AudioConnection_F32 patchCord11(BTNRH_alg1, 0, i2s_out, EarpieceShield::OUTPUT_LEFT_EARPIECE);   //send to the left earpiece
...
void setup() { //this runs once at startup
    ...
    // Start the Tympan and the AIC shields
