/*
   chapro_test_GHA_EarpieceManualMixing
...
//connect the input mixers to the BTNRH alg
AudioConnection_F32  patchCord1(inputMixerL, 0, BTNRH_alg1, 0); //send to the left ear algorithm
AudioConnection_F32  patchCord2(inputMixerR, 0, BTNRH_alg2, 0); //send to the right ear algorithm
...
void setup() { //this runs once at startup
    ...
    myTympan.println("CHAPRO for Tympan: Test GHA Earpiece Manual Mixing: setup():...");
