...
//connect to BTNRH algorithm
AudioConnection_F32   patchCord6(audio_in, 0, BTNRH_alg1, 0);
AudioConnection_F32   patchCord7(BTNRH_alg1, 0, gain1, 0);

//connect the BTNRH alg to the outputs
AudioConnection_F32   patchCord11(gain1, 0, audio_out,  0);    //Tympan AIC, left output
AudioConnection_F32   patchCord12(gain1, 0, audio_out,  1);   //Tympan AIC, right output
//AudioConnection_F32   patchCord13(gain1, 0, audio_out,  2);  //Shield AIC, left output
//AudioConnection_F32   patchCord14(gain1, 0, audio_out,  3); //Shield AIC, right output
